...
### 4.4 민원서식 (`src/data/forms.json`)

현재 등록된 서식 4종입니다. 모두 법령 별지서식 원본(HWPX)이며, 파일에 적힌 근거 법령·별지 번호·개정일을
그대로 옮겼습니다.

| 서식 | 근거 | 개정일 | 커버하는 민원 |
| --- | --- | --- | --- |
| 주민등록표 열람 또는 등·초본 교부 신청서 | 주민등록법 시행규칙 별지 제7호서식 | 2026-04-28 | 등·초본 발급, 주민등록표 열람 |
| 전입신고서(세대 모두 이동) | 주민등록법 시행령 별지 제15호서식 | 2024-12-03 | 전입신고 |
| 전입세대확인서 열람 또는 교부 신청서 | 주민등록법 시행규칙 별지 제15호서식 | 2024-12-20 | 전입세대확인서 |
| 지적공부·부동산종합공부 열람·발급 신청서 | 공간정보관리법 시행규칙 별지 제71호서식 | 2021-08-05 | 토지대장, 지적도, 경계점좌표등록부, 부동산종합증명서 |

확인할 것:

- [ ] 각 서식이 **현행 최신본**인지 (국가법령정보센터에서 개정일 대조)
- [ ] `lawUrl` 이 실제로 열리는지 — 빌드 환경에서 law.go.kr 접속이 차단되어 확인하지 못했습니다
- [ ] 전입신고는 '세대 모두 이동' 서식만 실려 있습니다. 세대 일부 이동·세대주 변경 서식이
      따로 필요한지 담당부서 확인 필요

아직 서식이 없는 민원(인감신고, 인감변경신고, 토지이용계획확인, 건축물대장, 건축물 부존재증명,
정보공개청구, 발급제한 신청 등)은 서식을 확보하는 대로 같은 방식으로 추가하면 됩니다.

### 4.5 서식에서 확인해 채운 항목

다음은 **별지서식 본문에 인쇄된 법정 수수료·처리기간**을 근거로 채웠습니다. 담당부서 확인 시 함께 봐 주세요.

| 민원 | 채운 값 | 근거 |
| --- | --- | --- |
| 전입세대확인서 | 열람 300원 / 교부 400원 (제29조의2제2항제3호는 500원), 즉시 | 주민등록법 시행규칙 별지 제15호서식 |
| 토지(임야)대장 | 열람 300원 / 발급 500원, 인터넷 무료, 즉시 | 공간정보관리법 시행규칙 별지 제71호서식 |
| 지적도(임야도) | 열람 400원 / 발급 700원, 인터넷 무료, 즉시 | 〃 |
| 경계점좌표등록부 | 열람 300원 / 발급 500원, 인터넷 무료, 즉시 | 〃 |
| 부동산종합증명서 | 열람 무료, 발급 종합형 1,500원·맞춤형 1,000원 (인터넷 1,000원·800원), 즉시 | 〃 |

### 4.6 전체 항목에서 비어 있는 필드
